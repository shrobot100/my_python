...
class Node:
	...
	#	print(acc_sum/len(acc_list))
		...
		mat = getRotationMatrix(rpy[0],rpy[1],rpy[2])
		...
		imu_world_out.linear_acceleration.x = accel_world[0]
		imu_world_out.linear_acceleration.y = accel_world[1]
		imu_world_out.linear_acceleration.z = accel_world[2]

		self.pub.publish(imu_world_out)
	...
	def __init__(self):
		...
		self.pub = rospy.Publisher('/accel_world',Imu,queue_size=10)
